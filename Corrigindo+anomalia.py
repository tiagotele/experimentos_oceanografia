...
def carrega_array_com_valores_do_arquivo_geral(arquivo_com_decadas_de_anomalia ="funceme_db/anomalia/geral/_Dados_TSMvento_2014_04_anomt6414b04"):
    ...
    for rows_index in range(QUANTIDADE_DE_VALORES_DO_ARQUIVO):
        ...
        value = float(conteudo_do_arquivo[rows_index * quantidade_de_caracteres_do_valor_no_arquivo: rows_index * quantidade_de_caracteres_do_valor_no_arquivo + quantidade_de_caracteres_do_valor_no_arquivo])
        value /= 10
...
for date,row in funceme_df.iterrows():
    ...
    if datetime_object.month == 1:
        ...
        print("media mensal ", row["media_mensal"])
        print("climatologia janeiro ", climatologia_janeiro)
        print("anomalia do mes ", anomalia_do_mes)
    if datetime_object.month == 2:
